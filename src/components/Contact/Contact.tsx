...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setTimeout(() => {
      setStatus({ submitted: false, success: false });
      setFormData({ name: '', email: '', subject: '', message: '' });
    }, 3000);
  };

  const socialLinks = [
    { platform: 'github', url: 'https://github.com/RemyRedon' },
    {
      platform: 'linkedin',
      url: 'https://linkedin.com/in/rémy-redon-9a56411b3/',
    },
  ];
      ...
      <div className="container">
        ...
        <div className="contact-content">
          ...
          <div className="contact-info">
            ...
            {/* Affichage horizontal des informations de contact */}
            <div className="contact-items-wrapper">
              <ContactInfoItem
                icon="location"
                title="Localisation"
                content="Bordeaux, France"
              />
              <ContactInfoItem
                icon="email"
                title="Email"
                content="remy.redon@hotmail.fr"
              />
              <ContactInfoItem
                icon="phone"
                title="Téléphone"
                content="+33 6 75 86 29 70"
              />
            </div>
